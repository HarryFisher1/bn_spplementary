...
```{r nlehigh, out.width="50%", fig.pos="H", fig.cap="NLE fixed to High", fig.align='center'}
include_graphics("figs/measures/samiams/network4.png")
```

```{r nlestiffhigh, out.width="50%", fig.pos="H", fig.cap="NLE and stiffness fixed to High", fig.align='center'}
...
```{r nlelow, out.width="50%", fig.pos="H", fig.cap="NLE fixed to \"Low\"", fig.align='center'}
include_graphics("figs/measures/samiams/network9.png") 
```

```{r nlestifflow, out.width="50%", fig.pos="H", fig.cap="NLE and Stiffness both fixed to \"Low\" ", fig.align='center', fig.height=5, fig.width=5}
